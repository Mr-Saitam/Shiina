const discordJS = require('../../../../../package.json').dependencies['discord.js'] || require('../../../../../package.json').devDependencies['discord.js'];
...
async function profileImage(userParam){
    ...
    if(user.displayAvatarURL({forceStatic: false})?.endsWith(".gif") || user.bannerURL()){
        ...
        const nitro = await read(`${process.cwd()}/node_modules/discord-arts/src/Images/profileImage/Badges/v14/Nitro.png`)
    ...
    if(!user.bot){
        ...
        for (let i = 0; i < flags.length; i++) {
            let badge = await read(`${process.cwd()}/node_modules/discord-arts/src/Images/profileImage/Badges/v14/${flags[i]}.png`);
            badges.push(badge);
          }
